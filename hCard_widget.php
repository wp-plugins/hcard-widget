...
class  ind_hCard_widget extends WP_Widget {
 
 
    /** constructor -- name this the same as the class above */
    function ind_hCard_widget() {
...
add_action('widgets_init', create_function('', 'return register_widget("ind_hCard_widget");'));
