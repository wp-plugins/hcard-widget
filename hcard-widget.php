...
add_action( 'plugins_loaded', 'hcard_widget_load_textdomain' );
/**
 * Load plugin textdomain. 
 *
 * @since 1.0.0
 */
function hcard_widget_load_textdomain() {
  load_plugin_textdomain( 'hcard-widget', false, dirname( plugin_basename( __FILE__ ) ) . '/languages' ); 
}
...
function hcard_admin_pages($pages) 

  {
	...
	$pages[] = array(
      ...
      ,'default_tab' => __('Basic','hcard-widget')

      ,'save_text' => __('Save Settings','hcard-widget')
